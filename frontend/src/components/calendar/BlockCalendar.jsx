...
export default function BlockCalendar() {
  ...
  const summary = useMemo(() => {
    ...
    const departments = new Set(
      plans
        .map(p =>
          p.trains?.find(item => item.task)?.task?.department
        )
        .filter(Boolean)
    );
  ...
  const taskId =
    selected?.trains?.find(item => item.task_id)?.task_id;
    ...
    <>
      ...
      <div className="calendar-heading">
        <div className="calendar-heading-copy">
          ...
          <p className="calendar-subtitle">
            Coordinate railway maintenance blocks, train movements
            and operational availability from one planning view.
          </p>
        </div>
      ...
      <div className="calendar-kpis">
        ...
        <div className="calendar-kpi">
          <div className="calendar-kpi-top">
            <span>Total blocks</span>
            <div className="calendar-kpi-icon">▦</div>
          </div>
          ...
          {loading ? (
            ...
            <BigCalendar
              ...
              messages={{
                ...
                agenda: 'Agenda',
                noEventsInRange:
                  'No railway blocks scheduled for this period.'
              }}
            />
          )}
      ...
      {selected && (
        <div className="calendar-detail-overlay">
          ...
          <div className="calendar-detail-panel">
            ...
            <button
              className="close calendar-close"
            ...
            <div className="detail-panel-header">
              ...
              <div className="detail-title-row">
                ...
                <div>
                  <h2>
                    {selected.section || 'Railway block'}
                  </h2>
            ...
            {taskId && (
              <div className="detail-section">
                ...
                <p className="muted">
                  This block is linked to a maintenance task.
                  Planning intelligence can be reviewed from
