...
export default function Sidebar() {
  ...
  return <aside className="app-sidebar"><div className="logo"><span>IR</span><div>Railway<br /><small>Block Control</small></div></div><nav>{ordered.map(([to, text]) => <NavLink key={to} to={to} end={to === '/'}>{text}</NavLink>)}</nav><div className="sidebar-foot"><span className="status-dot" /> Systems online</div></aside>;
}
